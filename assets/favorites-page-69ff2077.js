...
</div>`}function j({author:e,quote:t}){return`
          <p class="text-quote list-item-text">${t}</p>
          <p class="autor-quote list-item-text">${e}</p>
        `}function ce(e,t){a.pagination.innerHTML=Ae(e,t)}const _="https://your-energy.b.goit.study/api/",Re={bodypart:"Body parts",muscles:"Muscles",equipment:"Equipment"};class je{constructor({filter:t="muscles",subFilter:s="",keyword:i="",page:r=1,limit:o=8}){this.filter=t,this.subFilter=s,this.keyword=i,this.page=r,this.limit=o,this.id=""}async getFilters(){return(await F.get(`${_}filters`,{params:{filter:Re[this.filter],page:this.page,limit:this.limit}})).data}async getExercises(){return(await F.get(`${_}exercises`,{params:{[this.filter]:this.subFilter,keyword:this.keyword,page:this.page,limit:this.limit}})).data}async getExerciseById(t){const s=await F.get(`${_}exercises/${t}`);return this.id=t,s.data}async updateExerciseRating({rate:t,email:s,review:i}){return(await F.patch(`${_}exercises/${this.id}/rating`,{rate:t,email:s,review:i})).data}async getQuote(){return(await F.get(`${_}quote`)).data}async subscribe({email:t}){return(await F.post(`${_}subscription`,{email:t})).data}}const d=new je({});async function O(){const e=await d.getExercises();a.gallery.innerHTML=ye(e.results),ce(Number(e.page),e.totalPages)}ne.settings({timeout:5e3,resetOnHover:!0,position:"bottomCenter",transitionIn:"flipInX",transitionOut:"flipOutX",theme:"dark",backgroundColor:"#242424"});function Z(e){ne.show({overlay:!0,overlayClose:!0,progressBarColor:"#BF5858",message:e})}function xe(e){ne.show({progressBarColor:"#4FAC40",message:e})}async function C(){try{const e=await d.getFilters();a.gallery.innerHTML=Be(e.results),ce(Number(e.page),e.totalPages)}catch{Z(h.ERROR_MESSAGE),a.gallery.innerHTML="<p>Nothing was found<p/>"}}async function Ee(){const e=new Date,t=`${e.getDate()}/${e.getMonth()}/${e.getFullYear()}`;let s;const i=JSON.parse(localStorage.getItem(h.LS_KEY_QUOTE));if(i)if(t!==i.date){try{s=await d.getQuote(),s.quote=s.quote||h.BASE_QUOTE.quote,s.author=s.author||"Unknown"}catch{a.quote.insertAdjacentHTML("beforeend",j(h.BASE_QUOTE));return}s.author!=="Unknown"&&s.quote!==h.BASE_QUOTE.quote&&(s.date=t,localStorage.setItem(h.LS_KEY_QUOTE,JSON.stringify(s))),a.quote.insertAdjacentHTML("beforeend",j(s))}else a.quote.insertAdjacentHTML("beforeend",j(i));else{try{s=await d.getQuote(),s.quote=s.quote||h.BASE_QUOTE.quote,s.author=s.author||"Unknown"}catch{a.quote.insertAdjacentHTML("beforeend",j(h.BASE_QUOTE));return}s.author!=="Unknown"&&s.quote!==h.BASE_QUOTE.quote&&(s.date=t,localStorage.setItem(h.LS_KEY_QUOTE,JSON.stringify(s))),a.quote.insertAdjacentHTML("beforeend",j(s))}}function Ce(e,t,s){a.gallery.innerHTML=ye(e,"favorites"),ce(t,s)}function z(e){if(e==="top")window.scrollTo({top:0,behavior:"smooth"});else{const t=e;if(t){const s=t.getBoundingClientRect();if(s.top>=0&&s.bottom<=(window.innerHeight||document.documentElement.clientHeight))return;window.scrollBy({top:s.top-20,behavior:"smooth"})}}}const we={mobile:{subfilters:9,exercises:8,favorites:8},tablet:{subfilters:12,exercises:10,favorites:10},desktop:{subfilters:12,exercises:10,favorites:999}};let ue=Le(window.screen.width);const nt=new ResizeObserver(e=>{let t=Le(e[0].devicePixelContentBoxSize[0].inlineSize);ue!==t&&(ue=t,R.refreshLimits(we[t]))});function Ue(){let e="desktop";return window.screen.width<768&&(e="mobile"),window.screen.width>=768&&window.screen.width<1440&&(e="tablet"),we[e]}function Le(e){let t="desktop";return e<768&&(t="mobile"),e>=768&&e<1440&&(t="tablet"),t}var g,S,x,$,E,b,w,L,B,Q,se,I,J,N,ie;class De{constructor({state:t,filter:s,subfiltersPage:i,subfilter:r,searchQuery:o,exercisesPage:l,limits:f}){p(this,L);p(this,Q);p(this,I);p(this,N);p(this,g,void 0);p(this,S,void 0);p(this,x,void 0);p(this,$,void 0);p(this,E,void 0);p(this,b,void 0);p(this,w,void 0);c(this,g,t),c(this,S,s),c(this,x,i),c(this,$,r),c(this,E,o),c(this,b,l),c(this,w,f)}load(){switch(Ee(),d.limit=n(this,w)[n(this,g)],d.filter=n(this,S),n(this,g)){case"subfilters":d.page=n(this,x),C(),u(this,I,J).call(this);break;case"exercises":d.subFilter=n(this,$),d.keyword=n(this,E),d.page=n(this,b),O(),u(this,Q,se).call(this,n(this,$));break}a.pagination.addEventListener("click",Ge),a.body.dataset.page==="home"&&(u(this,N,ie).call(this,n(this,S)),a.filter.addEventListener("click",Qe),a.subscribeForm.addEventListener("submit",Xe),a.policyBtn.addEventListener("click",me),a.termsBtn.addEventListener("click",me))}changeFilter(t){d.filter=t,d.page=1,d.limit=n(this,w).subfilters,C(),u(this,N,ie).call(this,t,n(this,S)),c(this,g,"subfilters"),c(this,S,t),c(this,x,1),u(this,I,J).call(this),u(this,L,B).call(this)}goExercises(t){d.subFilter=t,d.keyword="",d.page=1,d.limit=n(this,w).exercises,O(),c(this,g,"exercises"),c(this,$,t),c(this,E,""),c(this,b,1),u(this,Q,se).call(this,t),u(this,L,B).call(this),z(a.gallerySubtitle)}goBack(){d.page=n(this,x),d.limit=n(this,w).subfilters,C(),c(this,g,"subfilters"),u(this,I,J).call(this),u(this,L,B).call(this)}changePage(t){switch(d.page=t,n(this,g)){case"subfilters":C(),c(this,x,t);break;case"exercises":O(),c(this,b,t);break}u(this,L,B).call(this),z(a.gallerySubtitle)}goSearch(t){d.keyword=t,d.page=1,O(),c(this,E,t),c(this,b,1),u(this,L,B).call(this)}resetSearch(){d.keyword="",d.page=1,O(),c(this,E,""),c(this,b,1),u(this,L,B).call(this)}refreshLimits(t){switch(this.limits=t,d.limit=n(this,w)[n(this,g)],n(this,g)){case"subfilters":C();break;case"exercises":O();break}}}g=new WeakMap,S=new WeakMap,x=new WeakMap,$=new WeakMap,E=new WeakMap,b=new WeakMap,w=new WeakMap,L=new WeakSet,B=function(){sessionStorage.setItem(h.SS_KEY_FILTERS,JSON.stringify({state:n(this,g),filter:n(this,S),subfiltersPage:n(this,x),subfilter:n(this,$),searchQuery:n(this,E),exercisesPage:n(this,b)}))},Q=new WeakSet,se=function(t){a.gallery.dataset.cards="exercises",a.backBtn.classList.remove("back-button-hidden"),a.searchForm.classList.remove("search-form-hidden"),a.gallerySubtitle.innerHTML=`<span class="exercises-title">&nbsp;/</span><h3 class="exercises-subtitle">${t}</h3>`,a.gallery.addEventListener("click",re),a.backBtn.addEventListener("click",be),a.searchForm.addEventListener("input",de(ve,1e3,{leading:!1,trailing:!0})),a.gallery.removeEventListener("click",pe),a.searchForm.reset()},I=new WeakSet,J=function(){a.gallery.dataset.cards="subfilters",a.backBtn.classList.add("back-button-hidden"),a.searchForm.classList.add("search-form-hidden"),a.gallerySubtitle.innerHTML="",a.gallery.addEventListener("click",pe),a.gallery.removeEventListener("click",re),a.backBtn.removeEventListener("click",be),a.searchForm.removeEventListener("input",de(ve,1e3,{leading:!1,trailing:!0}))},N=new WeakSet,ie=function(t,s){[...a.filter.children].forEach(({firstElementChild:i})=>{switch(i.dataset.filter){case t:i.classList.add("filter-button-active");break;case s:i.classList.remove("filter-button-active");break}})};const R=new De({...JSON.parse(sessionStorage.getItem(h.SS_KEY_FILTERS))??{state:"subfilters",filter:"muscles",subfiltersPage:1,subfilter:"",searchQuery:"",exercisesPage:1},limits:Ue()});function Qe(e){e.target.hasAttribute("data-filter")&&R.changeFilter(e.target.dataset.filter)}async function pe(e){if(e.preventDefault(),!e.target.closest("[data-subfilter]"))return;const{subfilter:t}=e.target.closest("[data-subfilter]").dataset;R.goExercises(t)}function Ne(e){const t=document.querySelector(".add-favorites-btn");D.isFavorite(e._id)?(D.removeFavorite(e._id),t.style.padding="12px 16px",t.querySelector("span").textContent="Add to favorites",t.querySelector("use").setAttribute("href",Se)):(D.addFavorite(e),t.style.padding="12px 9px",t.querySelector("span").textContent="Remove from favorites",t.querySelector("use").setAttribute("href",oe))}const He=/^\w+@[a-zA-Z_]+?.[a-zA-Z]{2,3}$/;function Ke(e,t){const[s,i,r]=t.querySelectorAll(".users_rating, label"),[o,l,f]=t.querySelectorAll(".error");e.rate?(s.classList.add("invalid"),o.textContent=e.rate):(s.classList.remove("invalid"),o.textContent=""),e.email?(i.classList.add("invalid"),l.textContent=e.email):(i.classList.remove("invalid"),l.textContent=""),e.review?(r.classList.add("invalid"),f.textContent=e.review):(r.classList.remove("invalid"),f.textContent="")}function ke({rate:e,email:t,review:s}){const i={isInvalid:!1};return e||(i.isInvalid=!0,i.rate="Please select a rating"),t||(i.isInvalid=!0,i.email="Please enter an email"),He.test(t)||(i.isInvalid=!0,i.email="Please enter a valid email"),s||(i.isInvalid=!0,i.review="Please enter a review"),i}async function Ye(e,t){e.preventDefault();const s=new FormData(e.target),i={rate:Number(s.get("rate")),email:s.get("email"),review:s.get("review")},r=ke(i);if(Ke(r,e.target),!r.isInvalid)try{const o=await d.updateExerciseRating(i);t()}catch(o){console.log(o),Z("Something went wrong. Please try again later.")}}function Je(e){const t=e.target.closest(".rating");if(!t)return;const s=t.querySelectorAll('[name="rate"]'),i=t.parentElement.firstElementChild;s.forEach(r=>{r.checked&&(i.textContent=r.value+".0")})}const k={detailsPopup:!1,ratingPopup:!1},he=e=>e.stopPropagation(),ze=(e,{closeCallback:t,submitCallback:s})=>{const i=e.querySelector(".modal__close-btn"),r=e.querySelector(".give_a_rating"),o=e.querySelector(".rating");r.setAttribute("novalidate",!0),o.addEventListener("click",l=>{Je(l)}),i.addEventListener("click",()=>{t()}),r.addEventListener("submit",l=>{l.preventDefault(),s(l)})},V=e=>{k.detailsPopup=!1,k.ratingPopup=!1,e==null||e.remove(),document.documentElement.classList.remove("no-scroll")},$e=(e,t,s)=>{t.remove(),e.innerHTML="",k.ratingPopup=!1,e.append(s)},ge=(e,t,s)=>{switch(!0){case(k.detailsPopup&&!k.ratingPopup):V(e);return;case(k.detailsPopup&&k.ratingPopup):$e(e,t,s);return;default:V(e);return}},Ve=(e,t)=>{const s=document.createElement("div");s.innerHTML=e;const i=s.querySelector(".exercise-modal-backdrop"),r=s.querySelector(".exercise-modal"),o=s.querySelector(".exercise-card-close-btn"),l=s.querySelector(".add-rating-btn"),f=s.querySelector(".add-favorites-btn"),m=document.querySelector("#modal-template").content.firstElementChild.cloneNode(!0);window.addEventListener("keydown",P=>{P.code==="Escape"&&ge(i,m,r)}),i.addEventListener("click",()=>{ge(i,m,r)}),r.addEventListener("click",he),m.addEventListener("click",he),o.addEventListener("click",()=>{V(i)}),l.addEventListener("click",()=>{k.ratingPopup=!0,i.innerHTML="",i.append(m)}),f.addEventListener("click",P=>{Ne(t)}),ze(m,{closeCallback:()=>$e(i,m,r),submitCallback:P=>Ye(P,()=>{V(i),xe("Thank you for your feedback!")})}),document.documentElement.classList.add("no-scroll"),k.detailsPopup=!0,document.body.append(i)};async function re(e){if(e.preventDefault(),!(!e.target.closest("[data-id]")||e.target.closest("[data-delete]")))try{const t=e.target.closest("[data-id]").dataset.id,s=await d.getExerciseById(t),i=Me(s),r=Ve(i,s)}catch(t){console.error(t),Z("Something went wrong. Please try again later.")}}function Ge({target:e}){if(!e.hasAttribute("data-page"))return;const t=parseInt(e.dataset.page);R.changePage(t)}const fe=document.querySelector(".footer-error");async function Xe(e){e.preventDefault();const t=new FormData(e.currentTarget),s={};t.forEach((r,o)=>{s[o]=r});const{email:i}=ke({email:s.subscribe});if(i)fe.classList.remove("visually-hidden");else{e.currentTarget.reset(),fe.classList.add("visually-hidden");try{const r=await d.subscribe({email:s.subscribe});xe(r.message)}catch(r){Z(r.response.data.message)}}}let te,U;function me(e){e.target===a.policyBtn&&(U=document.querySelector(".js-policy-modal"),te=document.querySelector(".js-policy-modal-close")),e.target===a.termsBtn&&(U=document.querySelector(".js-terms-modal"),te=document.querySelector(".js-terms-modal-close")),G(),U.addEventListener("click",Ze),te.addEventListener("click",G),window.addEventListener("keydown",qe)}function qe(e){e.code==="Escape"&&G()}function Ze(e){e.target===U&&G()}function G(){U.classList.toggle("is-hidden"),document.documentElement.classList.toggle("no-scroll"),window.removeEventListener("keydown",qe)}function ve(e){e.preventDefault();const t=a.searchForm.exercise.value.trim();R.goSearch(t)}function ot(){z("top")}function ct(){const{scrollTopBtn:e}=a;if(window.scrollY<100){e.classList.replace("js-scroll-top-button-active","hide-scroll-top-button");return}else e.classList.replace("hide-scroll-top-button","js-scroll-top-button-active")}async function be(e){R.goBack()}function We({target:e}){if(!e.hasAttribute("data-page"))return;const t=parseInt(e.dataset.page);D.changePage(t)}function lt(e){e.currentTarget===a.btnOpenBurger&&(a.burgerMenu.classList.remove("is-hidden"),document.querySelector("html").classList.add("no-scroll")),e.currentTarget===a.btnCloseBurger&&(a.burgerMenu.classList.add("is-hidden"),document.querySelector("html").classList.remove("no-scroll"))}function et(e){if(e.preventDefault(),!e.target.closest("[data-delete]"))return;const t=e.target.closest("[data-delete]").dataset.delete;D.removeFavorite(t)}const tt={mobile:{subfilters:9,exercises:8,favorites:8},tablet:{subfilters:12,exercises:10,favorites:10},desktop:{subfilters:12,exercises:10,favorites:999}};function st(){let e="desktop";return window.screen.width<768&&(e="mobile"),window.screen.width>=768&&window.screen.width<1440&&(e="tablet"),tt[e]}var v,y,q,M,X,Te,H,ae,T,A;class it{constructor(t,s,i,r){p(this,X);p(this,H);p(this,T);p(this,v,void 0);p(this,y,void 0);p(this,q,void 0);p(this,M,void 0);c(this,v,t),c(this,y,s),c(this,q,i),c(this,M,r)}load(){Ee(),u(this,T,A).call(this),a.gallery.addEventListener("click",re),a.gallery.addEventListener("click",et),a.pagination.addEventListener("click",We)}isFavorite(t){return n(this,v).some(s=>s._id===t)}removeFavorite(t){const s=n(this,v).map(i=>i._id).indexOf(t);n(this,v).splice(s,1),u(this,H,ae).call(this),n(this,M)==="favorites"&&u(this,T,A).call(this)}addFavorite(t){n(this,v).push(t),u(this,H,ae).call(this),n(this,M)==="favorites"&&u(this,T,A).call(this)}changePage(t){c(this,y,t),u(this,T,A).call(this),z(a.gallery)}refreshLimits(t){c(this,q,t.favorites),u(this,T,A).call(this)}}v=new WeakMap,y=new WeakMap,q=new WeakMap,M=new WeakMap,X=new WeakSet,Te=function(){sessionStorage.setItem(h.SS_KEY_FAVORITES,JSON.stringify(n(this,y)))},H=new WeakSet,ae=function(){localStorage.setItem(h.LS_KEY_FAVORITES,JSON.stringify(n(this,v)))},T=new WeakSet,A=function(){const t=Math.ceil(n(this,v).length/n(this,q));n(this,y)>t&&c(this,y,t);const s=[...n(this,v)].splice((n(this,y)-1)*n(this,q),n(this,q));Ce(s,n(this,y),t),u(this,X,Te).call(this)};const D=new it(JSON.parse(localStorage.getItem(h.LS_KEY_FAVORITES))??[],JSON.parse(sessionStorage.getItem(h.SS_KEY_FAVORITES))??1,st().favorites,a.body.dataset.page);export{ct as a,ot as b,a as e,D as f,R as g,lt as h,nt as r};
//# sourceMappingURL=favorites-page-69ff2077.js.map
