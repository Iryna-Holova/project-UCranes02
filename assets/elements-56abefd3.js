        ...
        <div class="card-cont-content">
          ...
          <ul class="list-info-exer">
            ...
            <li class="item-card-exer">
              ...
              <p class="text-info-exer size-body">${o}</p>
            </li>
            <li class="item-card-exer">
...
//# sourceMappingURL=elements-56abefd3.js.map
